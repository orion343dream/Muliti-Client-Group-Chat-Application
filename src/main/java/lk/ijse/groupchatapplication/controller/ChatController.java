...
public class ChatController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            ...
            Socket socket = new Socket("localhost", 3086);
        ...
        Thread messageReceiver = new Thread(()->{
            try {
                ...
                while (true) {
                    ...
                    lblName.setStyle("-fx-background-color: #ff0c0c;-fx-background-radius:5;-fx-font-size: 13;-fx-text-fill: #ffffff;-fx-alignment: center;-fx-padding: 5px;");

                    Label lblMessage = new Label();
                    lblMessage.setStyle("-fx-background-color: #ffffff;-fx-background-radius:5;-fx-font-size: 13;-fx-text-fill: #000000;-fx-alignment: center;-fx-padding: 5px;");
                    ...
                    if (message != null) {
                        Platform.runLater(() -> {
                            ...
                            if (message.startsWith("Image:")) {
                                ...
                                hBoxImage.setStyle("-fx-background-color: #00c94d;-fx-background-radius:15;-fx-alignment: center;-fx-padding: 20px 5px;");
    ...
    public void textSendOnAction(ActionEvent actionEvent) {
        ...
        messageLabel.setStyle("-fx-background-color: #00c94d;-fx-background-radius:5;-fx-font-size: 13;-fx-alignment: center;-fx-padding: 5px;");
    ...
    public void imageSendOnAction(ActionEvent actionEvent) {
        ...
        if (file != null) {
            try {
                ...
                imageHbox.setStyle("-fx-background-color: rgb(0,201,77);-fx-background-radius:5;-fx-alignment: center;-fx-padding: 2px 2px;");
